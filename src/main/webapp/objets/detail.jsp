...
<%
    ...
    boolean owner =
            objet != null
            && userId != null
            && userId == objet.getProprietaireId();
%>
<!DOCTYPE html>
<html lang="fr">
<head>
...
<header class="page-header">
    <div class="container">
        ...
        <p class="lead">
            Consultez les informations de l'annonce.
        </p>
    </div>
</header>
        ...
        <div class="row g-4">
            ...
            <div class="col-lg-6">
                ...
                <div class="panel accent-card p-4">
                    ...
                    <span
                        class="badge <%= "perdue".equals(
                                objet.getType()
                        ) ? "text-bg-danger" : "text-bg-success" %> mb-2">
                    ...
                    <% if (userId == null) { %>
                        ...
                        <a
                            ...
                            href="<%= request.getContextPath() %>/utilisateur?action=connexion">
                    ...
                    <% } else if (owner) { %>
                        ...
                        <a
                            ...
                            href="<%= request.getContextPath() %>/reclamation?action=mes-reclamations">
                    ...
                    <% } else if (
                        ...
                        <a
                            class="btn btn-primary"
                            href="<%= request.getContextPath() %>/reclamation?action=creer&id=<%= objet.getId() %>">
